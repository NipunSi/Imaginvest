...
//        }
    ...
    func getStats() {
        ...
        let returnButton = UIBarButtonItem(title: totalPortReturnString, style: .plain, target: self, action: #selector(showStats))
        
        DispatchQueue.main.async {
            self.navigationItem.rightBarButtonItems = [add, returnButton]
        }
    }
